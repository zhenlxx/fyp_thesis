...
% In
%-------------------------------------------------------------------------
\input{BasicInfo.tex}			% student edits this - title, name, email etc.
\input{TitlePage.tex}			% no editing required here
\input{Abstract.tex}
\input{Declaration.tex}			% needed only if the document must have a Declaration
...
%-------------------------------------------------------------------------
\input{c1.intro.tex}
\input{c2.compiler_tech.tex}
\input{c2.5.haskell.tex}
\input{c3.monad.tex}
\input{c7.monad_transformer.tex}
\input{c4.lang_design.tex}
\input{c6.lang_impl.tex}
\input{c8.summary.tex}
%\input{c5.futurework.tex}
